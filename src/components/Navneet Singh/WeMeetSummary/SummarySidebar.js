      ...
      <div className="sidebar">
        <div className="top_part_summary">
          <Link to="/dashboard" className="btn_back_summary">   
            <button><i class="fas fa-chevron-left"></i> Back To Dashboard</button>
          </Link>
          ...
          <Link to="/dashboard" className="btn_sw_summ">   
            <button >Start WeMeet <i class="fa fa-info-circle" aria-hidden="true"></i></button>
          </Link>
        </div>
        ...
        <nav className="clearfix s-navbar">
          <ul className="no_style">
            <li>
              <Link className="sidebar_links" to={`/wemeets/${props.id}/summary`}>
                Basic Info
              </Link>
            </li>
            <li>
              <Link className="sidebar_links" to={`/wemeets/${props.id}/sessions`}>
                Sessions           
              </Link>
            </li>
            <li>
              <Link className="sidebar_links" to={`/wemeets/${props.id}/speakers`}>
                Speakers &amp; Hosts
              </Link>
            </li>
            <li>
              <Link className="sidebar_links" to={`/wemeets/${props.id}/registrants`}>
                Registrants
              </Link>
            </li>
          </ul>
